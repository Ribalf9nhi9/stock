...
class Products extends Admin_Controller 
{
	...
	public function create()
	{
        ...
        $this->form_validation->set_rules("reorder_point", "Reorder Point", "trim|integer|greater_than_equal_to[0]");
	...
	{      
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            $this->data["sales_forecast"] = $this->model_products->getProductSalesForecast($product_id); // Default 90 days
            // Example for a different period: $this->data["sales_forecast_30_days"] = $this->model_products->getProductSalesForecast($product_id, 30);
